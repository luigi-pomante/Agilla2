 ...
 * This class implements a Java interface to the 'AgillaHeapMsg'
 * message type.
 */

package agilla.messages;

public class AgillaHeapMsg extends net.tinyos.message.Message {
    ...
    /** Create a new AgillaHeapMsg of size 26. */
    public AgillaHeapMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new AgillaHeapMsg of the given data_length. */
    public AgillaHeapMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaHeapMsg with the given data_length
     * and base offset.
     */
    public AgillaHeapMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaHeapMsg using the given byte array
     * as backing store.
     */
    public AgillaHeapMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public AgillaHeapMsg(byte[] data, int base_offset) {
     ...
     */
    public AgillaHeapMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaHeapMsg embedded in the given message
     * at the given base offset.
     */
    public AgillaHeapMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public AgillaHeapMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <AgillaHeapMsg> \n";
      try {
