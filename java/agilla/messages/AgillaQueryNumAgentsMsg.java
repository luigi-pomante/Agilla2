 ...
 * This class implements a Java interface to the 'AgillaQueryNumAgentsMsg'
 * message type.
 */

package agilla.messages;

public class AgillaQueryNumAgentsMsg extends net.tinyos.message.Message {
    ...
    /** Create a new AgillaQueryNumAgentsMsg of size 12. */
    public AgillaQueryNumAgentsMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new AgillaQueryNumAgentsMsg of the given data_length. */
    public AgillaQueryNumAgentsMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryNumAgentsMsg with the given data_length
     * and base offset.
     */
    public AgillaQueryNumAgentsMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryNumAgentsMsg using the given byte array
     * as backing store.
     */
    public AgillaQueryNumAgentsMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public AgillaQueryNumAgentsMsg(byte[] data, int base_offset) {
     ...
     */
    public AgillaQueryNumAgentsMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryNumAgentsMsg embedded in the given message
     * at the given base offset.
     */
    public AgillaQueryNumAgentsMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public AgillaQueryNumAgentsMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <AgillaQueryNumAgentsMsg> \n";
      try {
