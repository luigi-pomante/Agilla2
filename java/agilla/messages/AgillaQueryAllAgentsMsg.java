 ...
 * This class implements a Java interface to the 'AgillaQueryAllAgentsMsg'
 * message type.
 */

package agilla.messages;

public class AgillaQueryAllAgentsMsg extends net.tinyos.message.Message {

    /** The default size of this message type in bytes. */
    public static final int DEFAULT_MESSAGE_SIZE = 12;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 70;

    /** Create a new AgillaQueryAllAgentsMsg of size 12. */
    public AgillaQueryAllAgentsMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new AgillaQueryAllAgentsMsg of the given data_length. */
    public AgillaQueryAllAgentsMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryAllAgentsMsg with the given data_length
     * and base offset.
     */
    public AgillaQueryAllAgentsMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryAllAgentsMsg using the given byte array
     * as backing store.
     */
    public AgillaQueryAllAgentsMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public AgillaQueryAllAgentsMsg(byte[] data, int base_offset) {
     ...
     */
    public AgillaQueryAllAgentsMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaQueryAllAgentsMsg embedded in the given message
     * at the given base offset.
     */
    public AgillaQueryAllAgentsMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public AgillaQueryAllAgentsMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <AgillaQueryAllAgentsMsg> \n";
      try {
