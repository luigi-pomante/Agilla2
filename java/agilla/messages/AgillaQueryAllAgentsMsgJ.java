// $Id: AgillaQueryAllAgentsMsgJ.java,v 1.4 2006/04/05 10:28:19 borndigerati Exp $
 ...
 */
public class AgillaQueryAllAgentsMsgJ implements MessageJ, AgillaConstants {
	...
	public AgillaQueryAllAgentsMsgJ() {		
	}
	 ...
	 * @param flags The flags required by the query
	...
	public AgillaQueryAllAgentsMsgJ(AgillaQueryAllAgentsMsg msg) {
	...
	public int getType() {	
		return AgillaQueryAllAgentsMsg.AM_TYPE;
	}
	...
	public net.tinyos.message.Message toTOSMsg() {
		AgillaQueryAllAgentsMsg msg = new AgillaQueryAllAgentsMsg();
