 ...
 * This class implements a Java interface to the 'AgillaAckStateMsg'
 * message type.
 */

package agilla.messages;

public class AgillaAckStateMsg extends net.tinyos.message.Message {
    ...
    /** Create a new AgillaAckStateMsg of size 4. */
    public AgillaAckStateMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new AgillaAckStateMsg of the given data_length. */
    public AgillaAckStateMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckStateMsg with the given data_length
     * and base offset.
     */
    public AgillaAckStateMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckStateMsg using the given byte array
     * as backing store.
     */
    public AgillaAckStateMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public AgillaAckStateMsg(byte[] data, int base_offset) {
     ...
     */
    public AgillaAckStateMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckStateMsg embedded in the given message
     * at the given base offset.
     */
    public AgillaAckStateMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public AgillaAckStateMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <AgillaAckStateMsg> \n";
      try {
