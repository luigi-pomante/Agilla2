 ...
 * This class implements a Java interface to the 'AgillaAckRxnMsg'
 * message type.
 */

package agilla.messages;

public class AgillaAckRxnMsg extends net.tinyos.message.Message {
    ...
    /** Create a new AgillaAckRxnMsg of size 4. */
    public AgillaAckRxnMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new AgillaAckRxnMsg of the given data_length. */
    public AgillaAckRxnMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckRxnMsg with the given data_length
     * and base offset.
     */
    public AgillaAckRxnMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckRxnMsg using the given byte array
     * as backing store.
     */
    public AgillaAckRxnMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public AgillaAckRxnMsg(byte[] data, int base_offset) {
     ...
     */
    public AgillaAckRxnMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new AgillaAckRxnMsg embedded in the given message
     * at the given base offset.
     */
    public AgillaAckRxnMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public AgillaAckRxnMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <AgillaAckRxnMsg> \n";
      try {
    ...
    /**
     * Return the value (as a short) of the field 'msgNum'
     */
    public short get_msgNum() {
        return (short)getUIntBEElement(offsetBits_msgNum(), 8);
    }

    /**
     * Set the value of the field 'msgNum'
     */
    public void set_msgNum(short value) {
        setUIntBEElement(offsetBits_msgNum(), 8, value);
    }
