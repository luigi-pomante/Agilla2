 ...
 * @version 3.0
 */
//#include "NetworkInterface.h" //non utilizzato (fatto da noi)
#include "AM.h"

generic configuration NetworkInterfaceC(am_id_t amId) {
	provides {
...
implementation {
	components new AMSenderC(amId) as AMS, new AMReceiverC(amId) as AMR;
