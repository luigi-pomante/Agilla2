// $Id: DirectoryMgrI.nc,v 1.1 2006/03/19 06:09:29 chien-liang Exp $
 ...
 */
 interface DirectoryMgrI {
	 ...
	 */
	command error_t execute(AgillaAgentContext* agent, uint16_t op, uint16_t dest, AgillaTuple tuple);
