// $Id: LocationReporterI.nc,v 1.3 2006/04/09 00:02:56 chien-liang Exp $
...
interface LocationReporterI {
	 ...
	 */
	command error_t agentDied(AgillaAgentID* aid);
	 ...
	 */
	command error_t agentChangedDesc(AgillaAgentID* aid);	
	 ...
	 */
	command error_t updateLocation(AgillaAgentContext* context);
}
