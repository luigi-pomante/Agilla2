// $Id: OPlocM.nc,v 1.3 2006/02/06 09:40:40 chien-liang Exp $
 ...
 * Pushes the location of the mote onto the stack.
...
implementation {	
	...
	dbg("DBG_USR1", "VM (%i:%i): Executing OPloc (%i,%i).\n", context->id.id, context->pc-1, loc.x, loc.y);
