// $Id: OPrts.nc,v 1.6 2006/02/09 17:32:55 chien-liang Exp $
...
implementation {
	components MainC, OPrtsM, LocationMgrC, RemoteTSOpMgrProxy, AgentMgrC, TupleUtilC;
	components OpStackC, QueueProxy, ErrorMgrProxy, LedsC, NeighborListProxy as NbrList;

	BytecodeI = OPrtsM;	


	MainC.SoftwareInit -> OPrtsM.Init;
