// $Id: OPcistypeM.nc,v 1.2 2005/11/29 06:42:53 chien-liang Exp $
...
implementation {
	...
	if (call OpStackI.popOperand(context, &arg1) == SUCCESS) {
		...
		if (call OpStackI.popOperand(context, &arg2) == SUCCESS) {
