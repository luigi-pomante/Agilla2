// $Id: OPdecM.nc,v 1.2 2006/01/21 03:18:20 chien-liang Exp $
...
implementation {	
	...
	if (call Stacks.popOperand(context, &arg) == SUCCESS) {
		...
		dbg("DBG_USR1", "VM (%i:%i): Executing dec of location (%i,%i), mode %i, result = (%i,%i)\n", 
